...
var janus_one = null;
var screentest = null;
var opaqueId_ss = "screensharingtest-"+Janus.randomString(12);

var screenShareStart = false;

var myusername_ss = null;
var myid_ss = null;
						...
						janus_one.attach(
							{
								...
								success: function(pluginHandle) {
									...
									//$('#create').off("click");
									//$('#create').on("click", preShareScreen);
									preShareScreen()
									$('#screenShare').addClass("icon-active");
									// $('#joinnow').removeClass('hide').show();
									// $('#join').click(joinScreen);
									$('#desc').focus();
									$('#screenShare').removeAttr('disabled').html("")
										.click(function() {
								...
								onmessage: function(msg, jsep) {
									...
									if(event != undefined && event != null) {
										if(event === "joined") {
											...
											Janus.log("Successfully joined room " + msg["room"] + " with ID " + myid_ss);
											if(role === "publisher") {
...
// 	var register = { "request": "join", "room": room, "ptype": "publisher", "display": myusername_ss };
// 	screentest.send({"message": register});
// }

function newRemoteFeed_ss(id, display) {
